...
- [ ] **OPEN — album date ≠ original release date.** Spotify has no original-release field; `album.release_date` is the date of the album this copy is on. Compilations/remasters give the wrong year (e.g. "Rich Girl" shows 2010 from *70s 100 Hits*; the song is from 1977). The ISRC year code isn't it either (`USRC19206280` → 1992 registration). Options:
